...
new PlayerText:header_box[MAX_PLAYERS];
new PlayerText:header[MAX_PLAYERS];
new PlayerText:details_container[MAX_PLAYERS];
new PlayerText:footer_box[MAX_PLAYERS];
new PlayerText:skin_box[MAX_PLAYERS];
new PlayerText:skin_title[MAX_PLAYERS];
new PlayerText:arrow_left[MAX_PLAYERS];
new PlayerText:arrow_right[MAX_PLAYERS];
new PlayerText:skin_model[MAX_PLAYERS];
new PlayerText:name_title[MAX_PLAYERS];
new PlayerText:password_title[MAX_PLAYERS];
new PlayerText:confirm_password_title[MAX_PLAYERS];
new PlayerText:email_title[MAX_PLAYERS];
new PlayerText:gender_title[MAX_PLAYERS];
new PlayerText:register_box[MAX_PLAYERS];
new PlayerText:exit_box[MAX_PLAYERS];
new PlayerText:register_button[MAX_PLAYERS];
new PlayerText:exit_button[MAX_PLAYERS];
new PlayerText:name_input_box[MAX_PLAYERS];
new PlayerText:password_input_box[MAX_PLAYERS];
new PlayerText:confirm_password_input_box[MAX_PLAYERS];
new PlayerText:email_input_box[MAX_PLAYERS];
new PlayerText:gender_input_box[MAX_PLAYERS];
new PlayerText:name_input[MAX_PLAYERS];
new PlayerText:password_input[MAX_PLAYERS];
new PlayerText:confirm_password_input[MAX_PLAYERS];
new PlayerText:email_input[MAX_PLAYERS];
new PlayerText:gender_input[MAX_PLAYERS];
...
public OnPlayerConnect(playerid)
{
	...
	header[playerid] = CreatePlayerTextDraw(playerid, 320.000000, 47.000000, "Register_Account");
	PlayerTextDrawFont(playerid, header[playerid], 3);
	PlayerTextDrawLetterSize(playerid, header[playerid], 0.762498, 2.500000);
	PlayerTextDrawTextSize(playerid, header[playerid], 400.000000, -33.000000);
	PlayerTextDrawSetOutline(playerid, header[playerid], 1);
	PlayerTextDrawSetShadow(playerid, header[playerid], 0);
	PlayerTextDrawAlignment(playerid, header[playerid], 2);
	...
	PlayerTextDrawSetPreviewModel(playerid, skin_model[playerid], 262);
	...
	name_input[playerid] = CreatePlayerTextDraw(playerid, 353.000000, 148.000000, "Name_Input");
	...
	gender_input[playerid] = CreatePlayerTextDraw(playerid, 353.000000, 265.000000, "Gender_Input");
...
{
	PlayerTextDrawDestroy(playerid, header_box[playerid]);
	PlayerTextDrawDestroy(playerid, header[playerid]);
	PlayerTextDrawDestroy(playerid, details_container[playerid]);
	PlayerTextDrawDestroy(playerid, footer_box[playerid]);
	PlayerTextDrawDestroy(playerid, skin_box[playerid]);
	PlayerTextDrawDestroy(playerid, skin_title[playerid]);
	PlayerTextDrawDestroy(playerid, arrow_left[playerid]);
	PlayerTextDrawDestroy(playerid, arrow_right[playerid]);
	PlayerTextDrawDestroy(playerid, skin_model[playerid]);
	PlayerTextDrawDestroy(playerid, name_title[playerid]);
	PlayerTextDrawDestroy(playerid, password_title[playerid]);
	PlayerTextDrawDestroy(playerid, confirm_password_title[playerid]);
	PlayerTextDrawDestroy(playerid, email_title[playerid]);
	PlayerTextDrawDestroy(playerid, gender_title[playerid]);
	PlayerTextDrawDestroy(playerid, register_box[playerid]);
	PlayerTextDrawDestroy(playerid, exit_box[playerid]);
	PlayerTextDrawDestroy(playerid, register_button[playerid]);
	PlayerTextDrawDestroy(playerid, exit_button[playerid]);
	PlayerTextDrawDestroy(playerid, name_input_box[playerid]);
	PlayerTextDrawDestroy(playerid, password_input_box[playerid]);
	PlayerTextDrawDestroy(playerid, confirm_password_input_box[playerid]);
	PlayerTextDrawDestroy(playerid, email_input_box[playerid]);
	PlayerTextDrawDestroy(playerid, gender_input_box[playerid]);
	PlayerTextDrawDestroy(playerid, name_input[playerid]);
	PlayerTextDrawDestroy(playerid, password_input[playerid]);
	PlayerTextDrawDestroy(playerid, confirm_password_input[playerid]);
	PlayerTextDrawDestroy(playerid, email_input[playerid]);
	PlayerTextDrawDestroy(playerid, gender_input[playerid]);
	return 1;
}
